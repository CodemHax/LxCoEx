...
def build_docker_create_command(language: str, timeout_ms: int) -> list[str]:
    ...
    return [
        ...
        "--tmpfs", f"/tmp:rw,noexec,nosuid,mode=1777,size={settings.EXECUTION_SANDBOX_TMP_SIZE}",
        "--tmpfs", f"/workspace:rw,exec,nosuid,mode=1777,size={settings.EXECUTION_SANDBOX_WORKSPACE_SIZE}",
